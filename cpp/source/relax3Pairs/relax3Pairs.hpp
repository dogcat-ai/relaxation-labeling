#ifndef _RELAX3PAIR_HPP
#define _RELAX3PAIR_HPP

#include <unsupported/Eigen/CXX11/Tensor>
#include <Eigen/Dense>

struct RelaxationLabeling {
    const Eigen::Tensor<double, 6>& compatibility;
    int numObjects;
    int numLabels;
    ...
    RelaxationLabeling(const Eigen::Tensor<double, 6>& compatibility);
    void iterate();
    void updateSupport();
